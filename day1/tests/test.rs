...
mod test_module {
    ...
    fn test4() {
        assert_eq!(
            33583.0,
            functions::module_counting::count_fuel_needed(100756)
        );
    }
    #[test]
    fn test5() {
        assert_eq!(
            966.0,
            functions::module_counting::count_total_fuel_needed(1969)
        );
    }
    #[test]
    fn test6() {
        assert_eq!(
            503464903193.0,
            functions::module_counting::count_total_fuel_needed(100756)
        );
    }
}
